...
public class Lab1AllTests {
	...
	public void testMethodBeverageToString() throws Exception {
		...
		assertTrue("The method \"toString\" should be overridden in the Beverage class",
	...
	private void testSetterMethodExistsInClass(Class aClass, String methodName, Class inputType,
        ...
        assertEquals("incorrect return type for " + methodName + " method in " + aClass.getName() + ".", m.getReturnType(), Void.TYPE);

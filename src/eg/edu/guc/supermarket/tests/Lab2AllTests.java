...
public class Lab2AllTests {
	...
	String gPath = "eg.edu.guc.supermarket.model.products.GroceryProduct";
	String bPath = "eg.edu.guc.supermarket.model.products.Beverage";
	String dPath = "eg.edu.guc.supermarket.model.products.DairyProduct";
	String cPath = "eg.edu.guc.supermarket.model.cart.Cart";
	...
	public void testInstanceVariableBeverageSugarLevelGetter() throws Exception {
		testGetterMethodExistsInClass(Class.forName(bPath), "getSugarLevel",
				Class.forName("eg.edu.guc.supermarket.model.products.SugarLevel"));
	}
	...
	public void testInstanceVariableBeverageSugarLevelSetter() throws Exception {
		testSetterMethodExistsInClass(Class.forName(bPath), "setSugarLevel",
				Class.forName("eg.edu.guc.supermarket.model.products.SugarLevel"), true);
	}
	...
	public void testInstanceVariableDairyProductFatGetter() throws Exception {
		testGetterMethodExistsInClass(Class.forName(dPath), "getFat",
				Class.forName("eg.edu.guc.supermarket.model.products.Fat"));
	}
	...
	public void testInstanceVariableDairyProductFatSetter() throws Exception {
		testSetterMethodExistsInClass(Class.forName(dPath), "setFat",
				Class.forName("eg.edu.guc.supermarket.model.products.Fat"), true);
	}
	...
	@Test
	public void testMethodCartGetTotal() throws Exception {
	...
	@Test
	public void testMethodCartGetTotalLogic() throws Exception {
	...
	// ===============================================Helpers
		...
		private void testSetterMethodExistsInClass(Class aClass, String methodName,
            ...
            assertEquals("incorrect return type for " + methodName + " method in "
                    + aClass.getName() + ".", m.getReturnType(), Void.TYPE);
